...
// Payment model: kickoff fee paid upfront, success fee paid after success.
 ...
 *  - Public: paymentStatus (whitelisted), kickoffPaidAt, paidAt.
...
export function validatePatch(body, isAdmin) {
  ...
  for (const ts of ['kickoffPaidAt', 'paidAt']) {
